...
public class RocketMQAutoConfiguration {
    ...
    /**
     * Returns new {@link RocketMQRegistryProcessor} instance.
     * 
    ...
    public static class RocketMQRegistryProcessor implements EnvironmentAware, BeanDefinitionRegistryPostProcessor {
        ...
        public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
            ...
            var bindResult = Binder.get(environment).bind(RocketMQProperties.CONFIG_PREFIX, RocketMQProperties.class);
        ...
        private void registerProducer(ProducerProperties config) {
            ...
            if (config.getType() == ProducerType.DEFAULT) {
            ...
            } else if (config.getType() == ProducerType.TRANSACTION) {
                var beanDefinition = BeanDefinitionBuilder
